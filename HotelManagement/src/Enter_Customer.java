...
public class Enter_Customer extends Enter implements ActionListener {
	...
	public Enter_Customer() {
		...
		label_AccountNumber = new JLabel("’À∫≈£∫");
		txt_AccountNumber = new JTextField(10);
		
		label_Password = new JLabel("√‹¬Î£∫");
		txt_Password = new JPasswordField(10);
		
		button_Enter = new JButton("µ«¬º");
		button_Enter.addActionListener(this);
		
		button_Cancel = new JButton("∑µªÿ");
        button_Cancel.addActionListener(this);

		jpanel1.setBorder(new TitledBorder("”√ªßµ«¬º:"));
	...
	public void button_Enter_Click() {
		try {
			...
			//System.out.println(selectAccountNumberAndPassword);
			...
			if (accountNumberAndPasswordIsHavingData == false) {
				JOptionPane.showMessageDialog(this, "’À∫≈ªÚ√‹¬Î¥ÌŒÛ", "Ã· æ", JOptionPane.WARNING_MESSAGE);
