...
public class SelectRoomInterface extends JFrame implements ActionListener {
	...
	public SelectRoomInterface(String customerName) {
        ...
        try {
			...
			//System.out.println(SQL_SelectRSerialNumber);
			...
			if (currentRow == 0) {
		        ...
		        while (result_SelectRSerialNumber.next()) {
		                //System.out.println(count + "," + result_SelectRSerialNumber.getString(1) + " " + result_SelectRSerialNumber.getString(2) + " " + result_SelectRSerialNumber.getString(3) + " " + result_SelectRSerialNumber.getString(4) + " " + result_SelectRSerialNumber.getString(5));
